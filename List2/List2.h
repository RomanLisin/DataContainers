...
class List
{
    ...
    public:
        ...
        friend class List<T>;
    };// *Head, * Tail;  // ќбъ€вл€ем два указател€ на объекты класса 'Element' непостредственно после описани€ класса
...
public:
    ...
    List<T>(std::initializer_list<T>); // конструктор дл€ считывани€ массива List list = {  3, 5, 8, 13, 21 };
